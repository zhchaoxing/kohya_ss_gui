...
class NetworkTrainer:
    ...
    def process_batch(self, batch, is_train, tokenizers, text_encoders, unet, vae, noise_scheduler, vae_dtype,
                      weight_dtype, accelerator, args, train_text_encoder=True):
        with torch.no_grad():
        ...
        if cache_latents:
            ...
            with torch.no_grad():
                ...
                if val_dataset_group is not None:
                    ...
                    val_dataset_group.cache_latents(vae, args.vae_batch_size, args.cache_latents_to_disk,
